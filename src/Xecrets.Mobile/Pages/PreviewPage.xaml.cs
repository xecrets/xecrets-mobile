...
{
    public PreviewPage(PreviewPageModel model, IPageHeaderService pageHeaderService)
    {
        InitializeComponent();
    ...
    protected override async void OnAppearing()
    {
        ...
        await ((PreviewPageModel)BindingContext).InitializeCommand.ExecuteAsync(null);
    }
