...
public sealed class CrashTestService(IPlatformServices platformServices) : ICrashTestService
{
    ...
    public void Arm(CrashTestOperation operation, bool native)
    {
        _operation = operation;
        _native = native;
    }

    public void CrashIfArmed(CrashTestOperation operation)
    {
        ...
        throw new InvalidOperationException($"Artificial managed crash during {operation}.");
    }
}
